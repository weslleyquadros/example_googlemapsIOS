...
//        self.layer.masksToBounds=true
    ...
    class func instanceFromNib() -> UIView {
        return UINib(nibName: "PreviewMapsView", bundle: nil).instantiate(withOwner: self, options: nil).first as! UIView
    }
